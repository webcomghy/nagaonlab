@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Nagaon
Labratory')])
							...
							<div class="form-row">
								<div class="bmd-form-group mt-3">
									<div class="input-group">
										...
										<input type="text" name="lab_name" id="lab_name" class="form-control" placeholder="{{ __('Lab Name') }}"
											required>
									</div>
								</div>
								<div class="bmd-form-group mt-3">
									<div class="input-group">
										...
										<input type="text" name="lab_address" id="lab_address" class="form-control"
											placeholder="{{ __('Lab Address') }}" required>
									</div>
								</div>
							...
							<div class="form-row">
								...
								<div class="bmd-form-group mt-3">
									<div class="input-group">
										...
										<input type="text" name="center" id="center" class="form-control" placeholder="{{ __('Center Name') }}">
									</div>
								</div>
								<div class="bmd-form-group mt-3">
									<div class="input-group">
										...
										<input type="number" name="phone" id="phone" class="form-control" placeholder="{{ __('Phone Number') }}"
											required>
									</div>
								</div>
							</div>
								...
								<div class="bmd-form-group mt-3">
									<div class="input-group">
										...
										<input type="email" name="lab_email" id="lab_email" class="form-control"
											placeholder="{{ __('Lab Email Address') }}" required>
									</div>
								</div>
								<div class="bmd-form-group mt-3">
									<div class="input-group">
										...
										<select class="form-control" name="lab_type" id="lab_type" required>
											<option value="ns">Lab Type </option>
											<option value="M">Main Lab</option>
